...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module opr_mupair_i1_computation
  use kinds
  use omega95
  ...
  data table_flavor_states(:,   1) /  11, -11,  13, -13 / ! e- e+ mu- mu+

  integer, dimension(n_cindex,n_prt,n_cflow), save, protected :: table_color_flows
  data table_color_flows(:,:,   1) / 0,0,  0,0,  0,0,  0,0 /
  ...
  integer, save :: hel_finite = n_hel
    ...
    type(momentum) :: p12
    type(spinor) :: owf_fl2_p4, owf_fl1_p1
    type(conjspinor) :: owf_fl1b_p2, owf_fl2b_p3
    type(vector) :: owf_fa_p12, owf_fz_p12
    complex(kind=default) :: oks_fl1_fl1b_fl2_fl2b
...
contains
  ...
  pure function md5sum ()
    ...
    md5sum = "1846556C6F90E86B98E752EE60A4DF18"
  end function md5sum
  ...
  subroutine calculate_amplitudes (amp, k, mask)
    ...
    do hi = 1, hel_finite
      ...
      owf_fl2b_p3 = ubar (mass(13), p3, s(3))
      owf_fl2_p4 = v (mass(13), p4, s(4))
      call compute_fusions_0001 ()
      call compute_brakets_0001 ()
      amp(1,1,1,h) = oks_fl1_fl1b_fl2_fl2b
    end do
  ...
  subroutine compute_brakets_0001 ()
      oks_fl1_fl1b_fl2_fl2b = 0
      oks_fl1_fl1b_fl2_fl2b = oks_fl1_fl1b_fl2_fl2b + owf_fa_p12*( &
         + v_ff(qlep,owf_fl2b_p3,owf_fl2_p4))
      oks_fl1_fl1b_fl2_fl2b = oks_fl1_fl1b_fl2_fl2b + owf_fz_p12*( &
         + va_ff(gnclep(1),gnclep(2),owf_fl2b_p3,owf_fl2_p4))
      oks_fl1_fl1b_fl2_fl2b = &
         - oks_fl1_fl1b_fl2_fl2b ! 2 vertices, 1 propagators
      ! unit symmetry factor
  end subroutine compute_brakets_0001

end module opr_mupair_i1_computation
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! O'Mega API Version 1
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module opr_mupair_i1_api_v1
  use opr_mupair_i1_computation, only: number_particles_in, &
  ...
  implicit none
  public
end module opr_mupair_i1_api_v1
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! Backward compatible alias for O'Mega API Version 1
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module opr_mupair_i1
  use opr_mupair_i1_api_v1
  implicit none
  public
end module opr_mupair_i1
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! O'Mega API Version 3
! WORK IN PROCESS !!!!
! NOT FOR PRODUCTION !
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module opr_mupair_i1_api_v3
  use omega_birdtracks
  use omega_api_v3
  use opr_mupair_i1_computation
  implicit none
  private
...
end module opr_mupair_i1_api_v3
