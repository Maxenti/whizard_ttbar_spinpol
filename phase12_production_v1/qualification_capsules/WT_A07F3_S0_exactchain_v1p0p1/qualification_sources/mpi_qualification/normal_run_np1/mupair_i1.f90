...
!$OMP PARALLEL DO DEFAULT(SHARED) PRIVATE(s, h, tld) SCHEDULE(STATIC)
    do hi = 1, hel_finite
      ...
      tld%owf_fl2_p4 = v (mass(13), p4, s(4))
      call compute_fusions_0001 (tld)
      call compute_brakets_0001 (tld)
      amp(1,1,1,h) = tld%oks_fl1_fl1b_fl2_fl2b
    end do
!$OMP END PARALLEL DO
  ...
  type(thread_local_data), intent(inout) :: tld
      tld%oks_fl1_fl1b_fl2_fl2b = 0
      tld%oks_fl1_fl1b_fl2_fl2b = tld%oks_fl1_fl1b_fl2_fl2b + tld%owf_fa_p12* &
        ( + v_ff(qlep,tld%owf_fl2b_p3,tld%owf_fl2_p4))
      tld%oks_fl1_fl1b_fl2_fl2b = tld%oks_fl1_fl1b_fl2_fl2b + tld%owf_fz_p12* &
        ( + va_ff(gnclep(1),gnclep(2),tld%owf_fl2b_p3,tld%owf_fl2_p4))
      tld%oks_fl1_fl1b_fl2_fl2b = &
         - tld%oks_fl1_fl1b_fl2_fl2b ! 2 vertices, 1 propagators
