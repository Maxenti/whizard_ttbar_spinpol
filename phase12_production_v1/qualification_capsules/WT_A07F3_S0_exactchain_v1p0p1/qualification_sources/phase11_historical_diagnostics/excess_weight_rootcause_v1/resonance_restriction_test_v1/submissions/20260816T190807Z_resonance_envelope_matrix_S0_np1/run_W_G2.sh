...
SOURCE_CARD="/afs/cern.ch/user/c/cglenn/FCCWork/whizard/whizard_ttbar_spinpol/phase11_diagnostics/excess_weight_rootcause_v1/resonance_restriction_test_v1/sources/W_restricted/process.sin"
...
echo "============================================================"
echo "PHASE11_EXCESS_RESONANCE_MATRIX_V1_W_G2"
echo "MODE=$MODE"
...
payload = {
    ...
    "worker_version": "excess_resonance_matrix_v1/W_G2",
    "mode": mode,
