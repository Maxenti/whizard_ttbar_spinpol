...
Assume the archive is placed at `/eos/user/c/cglenn/FCCWork/whizard/packages/phase11_ttbar_restricted_region_suite_v1.tar.gz`.
...
export PKG_EOS=/eos/user/c/cglenn/FCCWork/whizard/packages/phase11_ttbar_restricted_region_suite_v1.tar.gz
export SUITE_BASE=$REPO/phase11_diagnostics/excess_weight_rootcause_v1/ttbar_restricted_region_suite_v1
export PKG=$SUITE_BASE/package_v1
