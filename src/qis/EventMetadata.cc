...
void write_summary_json(const RunSummary& s, const std::filesystem::path& output) {
  ...
  out << std::setprecision(17)
      ...
      << "  \"pythia_input_path\": \"" << escape_json(s.pythia_input_path) << "\",\n"
      ...
      << "  \"removed_auxiliary_weight_tags\": " << s.removed_auxiliary_weight_tags << ",\n"
      << "  \"last_pythia_event_size\": " << s.last_pythia_event_size << ",\n"
      << "  \"input_was_sanitized\": " << (s.input_was_sanitized ? "true" : "false") << ",\n"
