...
module opr_tt_prod_i1_computation
  ...
  data table_flavor_states(:,   1) /  11, -11,   6,  -6 / ! e- e+ t tbar
  ...
  type thread_local_data
    type(spinor) :: owf_fu3_i1_p4, owf_fl1_p1
    type(conjspinor) :: owf_fu3b_o1_p3, owf_fl1b_p2
    type(vector) :: owf_fa_p12, owf_fz_p12
    complex(kind=default) :: oks_fl1_fl1b_fu3_i1_fu3b_o1
...
contains
  ...
  pure function md5sum ()
    ...
    md5sum = "9E60235DE8274793A2E2C15C0C1F38C8"
  end function md5sum
...
!$OMP PARALLEL DO DEFAULT(SHARED) PRIVATE(s, h, tld) SCHEDULE(STATIC)
    do hi = 1, hel_finite
      ...
      amp(1,1,1,h) = tld%oks_fl1_fl1b_fu3_i1_fu3b_o1
    end do
!$OMP END PARALLEL DO
  ...
  type(thread_local_data), intent(inout) :: tld
      tld%oks_fl1_fl1b_fu3_i1_fu3b_o1 = 0
      tld%oks_fl1_fl1b_fu3_i1_fu3b_o1 = tld%oks_fl1_fl1b_fu3_i1_fu3b_o1 &
         + tld%owf_fa_p12*( + v_ff(qup,tld%owf_fu3b_o1_p3,tld%owf_fu3_i1_p4))
      tld%oks_fl1_fl1b_fu3_i1_fu3b_o1 = tld%oks_fl1_fl1b_fu3_i1_fu3b_o1 &
         + tld%owf_fz_p12*( &
         + va_ff(gncup(1),gncup(2),tld%owf_fu3b_o1_p3,tld%owf_fu3_i1_p4))
      tld%oks_fl1_fl1b_fu3_i1_fu3b_o1 = &
         - tld%oks_fl1_fl1b_fu3_i1_fu3b_o1 ! 2 vertices, 1 propagators
