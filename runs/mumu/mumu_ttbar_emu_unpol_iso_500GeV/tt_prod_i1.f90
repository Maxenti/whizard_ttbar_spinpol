! File generated automatically by O'Mega 3.1.5 release Sep 13 2024
!
!   /cvmfs/sw.hsf.org/key4hep/releases/2026-04-08/x86_64-almalinux9-gcc14.2.0-opt/whizard/3.1.5-nmagsz/bin/omega_SM.opt -o tt_prod_i1.f90 -target:whizard -target:parameter_module parameters_SM -target:module opr_tt_prod_i1 -target:md5sum 8B5F6BB72B54D0494797227ED80000C5 -target:openmp -fusion:progress -scatter "mu- mu+ -> t tbar"
!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module opr_tt_prod_i1_computation
  use kinds
  use omega95
  ...
  data table_flavor_states(:,   1) /  13, -13,   6,  -6 / ! mu- mu+ t tbar
  ...
  type thread_local_data
    type(spinor) :: owf_fu3_i1_p4, owf_fl2_p1
    type(conjspinor) :: owf_fu3b_o1_p3, owf_fl2b_p2
    type(vector) :: owf_fa_p12, owf_fz_p12
    complex(kind=default) :: oks_fl2_fl2b_fu3_i1_fu3b_o1
...
contains
  ...
  pure function md5sum ()
    ...
    md5sum = "8B5F6BB72B54D0494797227ED80000C5"
  end function md5sum
...
!$OMP PARALLEL DO DEFAULT(SHARED) PRIVATE(s, h, tld) SCHEDULE(STATIC)
    do hi = 1, hel_finite
      ...
      tld%owf_fl2_p1 = u (mass(13), - p1, s(1))
      tld%owf_fl2b_p2 = vbar (mass(13), - p2, s(2))
      tld%owf_fu3b_o1_p3 = ubar (mass(6), p3, s(3))
      tld%owf_fu3_i1_p4 = v (mass(6), p4, s(4))
      call compute_fusions_0001 (tld)
      call compute_brakets_0001 (tld)
      amp(1,1,1,h) = tld%oks_fl2_fl2b_fu3_i1_fu3b_o1
    end do
!$OMP END PARALLEL DO
  ...
  type(thread_local_data), intent(inout) :: tld
      tld%owf_fa_p12 = pr_feynman(p12, &
         + v_ff(qlep,tld%owf_fl2b_p2,tld%owf_fl2_p1))
      tld%owf_fz_p12 = &
         pr_unitarity(p12,mass(23),wd_tl(p12,width(23)),.false., &
         + va_ff(gnclep(1),gnclep(2),tld%owf_fl2b_p2,tld%owf_fl2_p1))
  end subroutine compute_fusions_0001
  subroutine compute_brakets_0001 (tld)
  type(thread_local_data), intent(inout) :: tld
      tld%oks_fl2_fl2b_fu3_i1_fu3b_o1 = 0
      tld%oks_fl2_fl2b_fu3_i1_fu3b_o1 = tld%oks_fl2_fl2b_fu3_i1_fu3b_o1 &
         + tld%owf_fa_p12*( + v_ff(qup,tld%owf_fu3b_o1_p3,tld%owf_fu3_i1_p4))
      tld%oks_fl2_fl2b_fu3_i1_fu3b_o1 = tld%oks_fl2_fl2b_fu3_i1_fu3b_o1 &
         + tld%owf_fz_p12*( &
         + va_ff(gncup(1),gncup(2),tld%owf_fu3b_o1_p3,tld%owf_fu3_i1_p4))
      tld%oks_fl2_fl2b_fu3_i1_fu3b_o1 = &
         - tld%oks_fl2_fl2b_fu3_i1_fu3b_o1 ! 2 vertices, 1 propagators
      ! unit symmetry factor
  end subroutine compute_brakets_0001

end module opr_tt_prod_i1_computation
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! O'Mega API Version 1
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module opr_tt_prod_i1_api_v1
  use opr_tt_prod_i1_computation, only: number_particles_in, &
  ...
  implicit none
  public
end module opr_tt_prod_i1_api_v1
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! Backward compatible alias for O'Mega API Version 1
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module opr_tt_prod_i1
  use opr_tt_prod_i1_api_v1
  implicit none
  public
end module opr_tt_prod_i1
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! O'Mega API Version 3
! WORK IN PROCESS !!!!
! NOT FOR PRODUCTION !
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module opr_tt_prod_i1_api_v3
  use omega_birdtracks
  use omega_api_v3
  use opr_tt_prod_i1_computation
  implicit none
  private
...
end module opr_tt_prod_i1_api_v3
